...
export const cards =
{
  greeting: {
    ...
    cards: [
      { text: 'Здравствуйте!', translatedText: 'Сайн байна! (Сайн!)', id: uuid.v4() },
      { text: 'Добрый день!', translatedText: 'Амгалан үдэр!', id: uuid.v4() },
      { text: 'Добрый вечер!	', translatedText: 'Амгалан үдэшэ!', id: uuid.v4() },
      { text: 'Как поживаете?', translatedText: 'Һайн байна гүт?', id: uuid.v4() },
      { text: 'Все ли у вас хорошо?', translatedText: 'Һайн гүт?', id: uuid.v4() },
      { text: 'Хорошо, в порядке, спасибо	', translatedText: 'Һайн, һайн даа! Һайнта даа!', id: uuid.v4() },
      { text: 'Давайте встетимся в фойе', translatedText: 'Фойе соо уулзая', id: uuid.v4() },
      { text: 'Передавай привет Баиру	', translatedText: 'Баярта мэндэ хүргөөрэй', id: uuid.v4() },
  ...
  family: {
    ...
    cards: [
      { text: 'У вас большая семья?', translatedText: 'Танай бүлэ ехэ гү?', id: uuid.v4() },
      { text: 'У нас большая семья.', translatedText: 'Манай бүлэ ехэ.', id: uuid.v4() },
      { text: 'Как зовут ваших родителей?', translatedText: 'Эжы абатнай хэн гэжэ нэрэтэйб?', id: uuid.v4() },
      { text: 'Мою маму зовут Эржэна.', translatedText: 'Минии эжы Эржэна гэжэ нэрэтэй.', id: uuid.v4() },
      { text: 'У вас есть сестры, братья?', translatedText: 'Танда аха дүүнэр бии гү?', id: uuid.v4() },
      { text: 'У меня есть старший брат / старшая сестра', translatedText: 'Нада аха / эгэшэ', id: uuid.v4() },
      { text: 'Сколько вашей матери / отцу лет?', translatedText: 'Танай эжы / аба хэдытэйб?', id: uuid.v4() },
      { text: 'Моей матери (моему отцу) 45 лет.', translatedText: 'Минии эжы / аба дүшэн табатай.', id: uuid.v4() },
      { text: 'Чем занимаются ваши родители?', translatedText: 'Танай түрэлхид юу хэдэг бэ?', id: uuid.v4() },
  ...
  goodbye: {
    ...
    cards: [
      ...
      { text: 'Да, да, вы правы', translatedText: 'Тиимэ, тиимэ, зүб хэлэнэт', id: uuid.v4() },
      { text: 'Нет', translatedText: 'Үгы', id: uuid.v4() },
      { text: 'Вы неправильно поняли', translatedText: 'Та буруу ойлгоот', id: uuid.v4() },
  ...
  weekdays: {
    ...
    cards: [
      ...
      { text: 'Какое сегодня число?', translatedText: 'Мунеедэр хэдэн бэ?', id: uuid.v4() },
      { text: 'Первое сентября', translatedText: 'Сентябриин нэгэн', id: uuid.v4() },
      { text: 'Который час?', translatedText: 'Хэды саг болооб?', id: uuid.v4() },
      { text: 'Десять часов	', translatedText: 'Арбан саг. Арбан час', id: uuid.v4() },
      { text: 'Десять с половиной', translatedText: 'Арба хахад', id: uuid.v4() },
